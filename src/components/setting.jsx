...
function SettingsToggle({ label, description, isOn, onToggle }) {
    return (
        <div className="flex items-center justify-between gap-4 rounded-2xl border border-slate-800/60 bg-slate-950/30 p-4 transition-colors hover:border-slate-700/80">
            <div>
    ...
    return (
        <div className="mx-auto max-w-4xl space-y-6 pb-12">
            ...
            <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center relative">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight text-white md:text-3xl">System Preferences</h1>
                    <p className="mt-1 text-sm text-slate-400">Manage automation protocols, edge node configs, and alerts.</p>
                </div>

                <div className="flex items-center gap-4">
                    {showSuccess && (
                        <span className="flex items-center gap-2 text-sm font-medium text-emerald-400 animate-pulse">
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
                ...
                <div className="flex flex-col gap-6 lg:col-span-7">
                    ...
                    {/* AI & Automation Block */}
                    <section className="rounded-3xl border border-slate-800/80 bg-slate-900/50 p-6 shadow-xl backdrop-blur-sm">
                        <div className="mb-5 flex items-center gap-3 border-b border-slate-800/80 pb-4">
                            <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-purple-500/30 bg-purple-500/10 text-purple-400 shadow-neon-purple">
                                <Sparkles className="h-5 w-5" />
                            </div>
                            <div>
                                <h2 className="text-lg font-semibold text-slate-200">AI Automation Protocols</h2>
                    ...
                    <section className="rounded-3xl border border-slate-800/80 bg-slate-900/50 p-6 shadow-xl backdrop-blur-sm">
                        <div className="mb-5 flex items-center gap-3 border-b border-slate-800/80 pb-4">
                            <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-amber-500/30 bg-amber-500/10 text-amber-400 shadow-neon-amber">
                ...
                <div className="flex flex-col gap-6 lg:col-span-5">
                    ...
                    <section className="rounded-3xl border border-slate-800/80 bg-slate-900/50 p-6 shadow-xl backdrop-blur-sm">
                        <div className="mb-5 flex items-center gap-3 border-b border-slate-800/80 pb-4">
                            <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-indigo-500/30 bg-indigo-500/10 text-indigo-400 shadow-[0_0_15px_rgba(99,102,241,0.2)]">
                                <User className="h-5 w-5" />
                            </div>
                            <div>
                                {/* NEW: Showing the user's name here! */}
                                <h2 className="text-lg font-semibold text-slate-200">Account: <span className="text-indigo-400">{userName}</span></h2>
                        ...
                        <button
                            ...
                            className="flex w-full items-center justify-center gap-2 rounded-xl border border-slate-700 bg-slate-800/50 py-3 text-sm font-medium text-slate-300 transition-all hover:border-slate-600 hover:bg-slate-800 hover:text-white"
                        >
                    ...
                    <section className="rounded-3xl border border-slate-800/80 bg-slate-900/50 p-6 shadow-xl backdrop-blur-sm">
                        <div className="mb-5 flex items-center gap-3 border-b border-slate-800/80 pb-4">
                            ...
                            <div>
                                <h2 className="text-lg font-semibold text-slate-200">IoT Edge Connection</h2>
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="mb-1.5 block text-xs font-medium text-slate-400">MQTT Broker URL</label>
                                <input
                                    type="text"
                                    value={brokerUrl}
                                    onChange={(e) => setBrokerUrl(e.target.value)}
                                    className="w-full rounded-xl border border-slate-700 bg-slate-950/50 px-4 py-2.5 text-sm font-mono text-cyan-400 transition-colors focus:border-cyan-500 focus:outline-none focus:ring-1 focus:ring-cyan-500/50"
                                />
                            </div>

                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label className="mb-1.5 block text-xs font-medium text-slate-400">Telemetry Sync</label>
                                    <select
                                        value={telemetrySync}
                                        onChange={(e) => setTelemetrySync(e.target.value)}
                                        className="w-full rounded-xl border border-slate-700 bg-slate-950/50 px-4 py-2.5 text-sm text-slate-200 focus:border-cyan-500 focus:outline-none"
                                    >
                                ...
                                <div>
                                    <label className="mb-1.5 block text-xs font-medium text-slate-400">QoS Level</label>
                                    <select
                                        value={qosLevel}
                    ...
                    <section className="rounded-3xl border border-red-500/20 bg-red-500/5 p-6 backdrop-blur-sm">
                        ...
                        <div className="space-y-3">
                            <button
                                ...
                                className="w-full rounded-xl border border-slate-700 bg-slate-900/50 py-2.5 text-sm font-medium text-slate-300 transition hover:bg-slate-800 hover:text-white"
                            >
